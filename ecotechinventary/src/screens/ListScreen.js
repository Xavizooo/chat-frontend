...
import { View, Text, FlatList, ActivityIndicator, StyleSheet, TouchableOpacity, Alert, TextInput, Button } from "react-native";
        ...
        if (rol == 'administrador'){
            return (
                <View style={styles.container}>
                    ...
                    <Button style={styles.button} color="purple" title="➕ Añadir Producto" onPress={() => setShowForm(true)}/>
